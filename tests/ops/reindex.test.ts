...
describe('init', () => {
  it('scaffolds ADR-0023 reference tree and reindexes', async () => {
    ...
    // AGENTS.md is generated by reindex, not scaffolded by init — a hand-written
    // copy in the scaffold would be exactly the drift generation prevents.
    expect(created).not.toContain('/AGENTS.md');
    expect(reindexed).toContain('/AGENTS.md');
  });
